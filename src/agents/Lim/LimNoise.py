...
class LimNoise(Agent):      # 수정필요!!
    def __init__(self, rng, name, context_dim):
        ...
        self.noise_init = self.noise = config['noise_init']     # self.noise initialization with 1
    ...
    def bid(self, state):
        ...
        with torch.no_grad():   
            ...
            # self.clone_network는 noise 추가된 깊은복수 network
